...
trap 'rm -f "$CRE_ENV"' EXIT
{
  ...
  echo "CRE_GOOGLE_REFRESH_TOKEN=${GOOGLE_REFRESH_TOKEN:-}"
  echo "CRE_GOOGLE_HEALTH_ACCESS_TOKEN=${GOOGLE_HEALTH_ACCESS_TOKEN:-}"
  echo "CRE_INGEST_SECRET=${CRE_INGEST_SECRET:-}"
