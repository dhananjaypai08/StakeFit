...
export function SignIn() {
  ...
  return (
    <main className="relative min-h-[calc(100vh-3.5rem)] overflow-hidden bg-ink-950">
      <img
        src={PHOTOS.hero}
      ...
      <div className="page-x relative flex min-h-[calc(100vh-3.5rem)] items-center py-12">
